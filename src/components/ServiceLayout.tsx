...
export default function ServiceLayout({ title, description, features }: Props) {
  return (
    <>
      <PageHero
        title={title}
      ...
      <section className="max-w-[var(--container)] mx-auto px-6 py-[var(--section-v)] grid grid-cols-[1fr_380px] max-[900px]:grid-cols-1 gap-20 max-[900px]:gap-12 items-start">
        ...
        <div className="flex flex-col gap-6">
          <div className="aspect-video bg-[linear-gradient(135deg,var(--color-green)_0%,var(--color-black)_100%)] flex items-center justify-center text-text-muted text-[0.75rem] tracking-[0.1em] uppercase">
            Zdjecie - placeholder
          </div>
